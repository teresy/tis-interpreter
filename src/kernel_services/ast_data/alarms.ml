  ...
  Datatype.Make_with_collections
    (struct
      ...
      let nb = function
        ...
        | Valid_string _ -> 15
        | Dangling _ -> 16
        | Division_overflow _ -> 17
        | Function_pointer _ -> 18
      ...
      let compare a1 a2 = match a1, a2 with
        ...
        | _, (Division_by_zero _ | Memory_access _ | Logic_memory_access _  |
              ...
              Differing_blocks _ | Valid_string _ | Division_overflow _ |
              Function_pointer _ )
          ->
