/* run.config
   OPT: -aorai-buchi tests/aorai/test_recursion2.promela -aorai-test 1 -aorai-acceptance -load-module tests/aorai/Aorai_test.cmxs -aorai-test-number @PTEST_NUMBER@ @NEEDS_WP_SHARE@
   OPT: -aorai-buchi tests/aorai/test_recursion3.promela -aorai-test 1 -aorai-acceptance -load-module tests/aorai/Aorai_test.cmxs -aorai-test-number @PTEST_NUMBER@ @NEEDS_WP_SHARE@
*/

/*
    OPT: -buchi tests/aorai/test_recursion2.promela -ltl-output-c-file tests/aorai/result/test_recursion2_annot.c  @NEEDS_WP_SHARE@
    OPT: tests/aorai/result/test_recursion2_annot.c -jessie -jessie-int-model exact -jessie-why-opt -fast-wp   @NEEDS_WP_SHARE@
*/
